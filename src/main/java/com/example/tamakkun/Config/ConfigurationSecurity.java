    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .requestMatchers("/api/v1/tamakkun-system/ticket/change-status/**","/api/v1/tamakkun-system/ticket/get-close-tickets","/api/v1/tamakkun-system/ticket/get-open-tickets", "/api/v1/tamakkun-system/auth/centre-verify/", "/api/v1/tamakkun-system/auth/get-unverified-centres", "/api/v1/tamakkun-system/auth/un-active-parent/","/api/v1/tamakkun-system/auth/get-all-un-active-parent/**"
                        ,"/api/v1/tamakkun-system/community/update/", "/api/v1/tamakkun-system/community/delete/", "/api/v1/tamakkun-system/centre/get-all-centres", "api/v1/tamakkun-system/review/get-All-reviews", "/api/v1/tamakkun-system/auth/get-all-users").hasAuthority("ADMIN")
                ...
                .requestMatchers("/api/v1/tamakkun-system/ticket/create-suggestion", "/api/v1/tamakkun-system/ticket/create-complaint-on-parent/").hasAnyAuthority("CENTRE","PARENT")
